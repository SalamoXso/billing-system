    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                <div class="mb-6">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Create New Invoice</h2>
                </div>
                ...
                <form action="{{ route('invoices.store') }}" method="POST" id="invoice-form">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="invoice_number" id="invoice_number" value="{{ old('invoice_number', 'INV-' . date('Ymd') . '-' . rand(100, 999)) }}" required
                                class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                    ...
                    <!-- Invoice Items -->
                    <div class="mt-6">
                        <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300 mb-3">Invoice Items</h3>
                        ...
                        <div id="invoice-items" class="space-y-4">
                            <div class="invoice-item bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <!-- Price (inc GST) -->
                                    <div>
                                        <label for="items[0][price]" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Price (inc GST)</label>
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 dark:text-gray-400 sm:text-sm">$</span>
                                            </div>
                                            <input type="number" name="items[0][price]" class="price-input pl-7 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" step="0.01" min="0" required>
                                        </div>
                                    </div>
                                    
                                    <!-- Serial Numbers Button -->
                                    <div class="flex items-end">
                                        <button type="button" class="serial-button hidden px-4 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-200 font-medium rounded">
                                            Serial Numbers
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="serial-numbers-container hidden mt-4 p-4 border border-gray-200 dark:border-gray-600 rounded-md">
                                    ...
                                    <textarea name="items[0][serial_numbers]" class="serial-numbers mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" rows="2" placeholder="SN001, SN002, ..."></textarea>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Enter one serial number per item, separated by commas.</p>
                                </div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="notes" id="notes" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mt-6 flex items-center justify-end">
                        <a href="{{ route('invoices.index') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100 mr-4">
                            Cancel
                        </a>
